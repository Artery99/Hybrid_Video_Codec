function [bitstream_B,MSE_B,XQ,R_B]=BlockIntraCoding2(current_block,q_mtx,dict_first_sym,dict_second_sym)
...
bitstream_B=RLC(quantized_block, blocksize, dict_first_sym,dict_second_sym);%Try RLC
